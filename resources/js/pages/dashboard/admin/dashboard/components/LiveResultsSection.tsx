...
export const LiveResultsSection = (): React.ReactElement => {
  const maxPercentage = Math.max(...mockResults.map((c) => c.percentage), 100);
  ...
  return (
    <section className="bg-white rounded-[20px] md:rounded-[25px] xl:rounded-[30px] border-2 border-[#80808080] shadow-[0px_4px_4px_#00000040] p-4 md:p-5 xl:p-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-0 mb-4 md:mb-5">
        <h2 className="text-[#53599b] text-xl md:text-2xl font-extrabold tracking-wide">
          Live Result
        </h2>
        <h3 className="text-[#53599b] text-xl md:text-2xl font-extrabold tracking-wide text-center">
